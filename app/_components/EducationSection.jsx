    ...
    <div className="my-16">
      ...
      {educationData.map((education, index) => (
        <div key={index} className="mt-12">
          <div className="border-b mb-2 flex flex-col lg:flex-row items-start px-8">
            <h1 className="text-4xl font-bold tracking-tighter flex-1">{education.school}</h1>
            <h3 className="text-xl font-light tracking-tighter flex-1 text-neutral-900 lg:text-right">
