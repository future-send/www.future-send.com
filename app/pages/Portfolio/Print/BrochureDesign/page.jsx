...
export default function Page() {
  const print = portfolioData[0].print[3];
  ...
  return (
    <div className="mt-40 pb-16">
      <PortfolioSinglePage2Col
        ...
        imgSrc={print.imgSrc.slice(0, 8)} // Passiamo l'array di immagini
      />

      <PortfolioSinglePage
        imgSrc={print.imgSrc.slice(8, 9)} // Passiamo l'array di immagini
      />
      <PortfolioSinglePage2Col
      ...
      <PortfolioSinglePage
        imgSrc={print.imgSrc.slice(11, 12)} // Passiamo l'array di immagini
      />
