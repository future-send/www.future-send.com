...
export default function Page() {
  const marketing = portfolioData[0].Marketing[3];
  ...
  return (
    <div className="mt-40 pb-16 animate__animated animate__fadeIn">
      ...
      <PortfolioSinglePage2Col
        imgSrc={marketing.imgSrc.slice(0, 8)} // Passiamo l'array di immagini
      />

      <PortfolioSinglePage
        imgSrc={marketing.imgSrc.slice(8, 9)} // Passiamo l'array di immagini
      />
      <PortfolioSinglePage2Col
      ...
      <PortfolioSinglePage
        imgSrc={marketing.imgSrc.slice(11, 12)} // Passiamo l'array di immagini
      />
