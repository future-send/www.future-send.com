    ...
    <>
      <main className="relative mt-32  text-white">
        <div className="relative flex items-center justify-center min-h-screen text-center px-4 sm:px-10 md:px-20 lg:px-32 xl:px-60 overflow-hidden text-neutral-400">
          <div>
            <div className="my-32">
              <h1 className="text-neutral-300 text-6xl sm:text-8xl md:text-8xl lg:text-8xl xl:text-9xl 2xl:text-[160px] font-bold border-b border-neutral-500 leading-tight tracking-tighter">Cris Delli-Zotti</h1>
